...
public class PropertiesDiskStorage
{
	...
	/** The properties that were read from disk. */
	private Properties properties;
	
	/** 
	 * When a list of strings is desired for a property name, 
	 * store the list in the hashtable. 
	 */
	private Hashtable<String, List<String>> hashtable;

	/**
	 * Initialize the instance by reading the properties from the file
	 * whose name is stored in propFileName.
