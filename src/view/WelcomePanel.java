...
/**
 * A panel to welcome a user and give the choice between playing a
 * game and viewing the high scores from past plays of the game.
 */
public class WelcomePanel extends ViewPanel
{
	...
	/**
	 * Create the welcome panel, with the game name, a button to
	 * start the game, and a button to request past high scores be shown.
	 * @param width		the width of the panel
	 * @param height 	the height of the panel
	 * @param listener	the class listening for the event 
	 * 					that signals a button was pressed
	 */
