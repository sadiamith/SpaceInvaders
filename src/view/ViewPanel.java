...
/**
 * A class for the panel to be placed in the frame of the main view.  
 * It has a function to return the Component within it to obtain
 * the focus when the containing frame is realized.
 */
