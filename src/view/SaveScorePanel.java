...
/**
 * A panel to display the user's score, and a text field for 
 * the user to enter their id so that their score can be saved
 * as a high score.
 */
public class SaveScorePanel extends ViewPanel
{
	...
	/**
	 * Create a panel to display the user's score, 
	 * a text field for the user to enter their id.
	 * @param width		the width of the panel
	 * @param height 	the height of the panel
	 * @param score		the user's score
	 * @param level		the user's level
	 * @param listener	the class listening for the event 
	 * 					that signals the Enter key was pressed
	 */
	public SaveScorePanel(int width, int height, int score, 
	                      int level, ActionListener listener)
	{
		...
		JLabel header = new JLabel("You are in the top "
		                + HighScores.MAX_NUMBER_SCORES_SAVED + "!");
