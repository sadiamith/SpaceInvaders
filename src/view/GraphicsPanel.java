...
/**
 * A panel with the method drawImage to draw an image in the panel where 
 * the image is obtained from an image cache by name, 
 * and the method drawString to display text in the panel.
 */
public class GraphicsPanel extends JPanel
{
	...
	protected void drawImage(int x, int y, int width, int height,
	                         String imageName, Graphics2D graphics)
	{
