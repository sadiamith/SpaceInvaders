...
/**
 * The panel to show the current game scene.  It is an observer of 
 * the game model in order to be notified of changes, and it accesses
 * information from the game via the GameInfoProvider interface.
 */
public class GamePanel extends GraphicsPanel implements GameObserver
{
	...
	/**
	 * Initialize the game panel, including setting it up 
	...
	/**
	 * Paint the game scene on the panel: the background and sprites. 
	 * If the game is paused or is over, include a message to that effect.
