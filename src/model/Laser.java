...
public class Laser extends GameObject 
{
	...
	/**
	 * Every clock tick, move MOVE_DISTANCE.
	 * Check for reaching the top or colliding with another object.  
	 * If neither of these happen, change image every changeFreq ticks.
	 */
	...
	/**
	 * Check for a collision with an invader, a block or a missile, 
	 * and if so, return the other object of the collision.
	 * A laser does not hit an explosion, the player, or another laser.
