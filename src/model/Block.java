...
/**
 * The model of a block that can withstand a certain number of hits 
...
public class Block extends GameObject
{
	...
	/** The number of times the block that must be 
	 *  hit before the block disappears. */
	...
	/**
	 * If a missile hits the block, change the image to show
	 * partial destruction.  When the number of hits reaches 
	 * the value numHits, the block disappears.
