...
public class Game implements GameControl, GameInfoProvider
{
	...
	public Game(int width, int height)
	{
		...
		/* Each barricade is 3 blocks high and 4 blocks wide. 
		 * Use equal gaps between the barricades and on both sides. */
	...
	/**
	 * Add a barricade with (xTopCenter, yTopCenter) as the
	 * coordinates for the top center of the barricade.
	 */
	...
	/**
	 * To start a new level, increment the level number 
	 * and generate a new set of invaders.
	 */
	...
	private void runGame()
	{
		while (!over && !paused)
		{
			...
			try
			{
				...
				{
					System.out.println("Time for the step at time " + tick 
							           + " was " + timeRequiredForStep);				
				}
	 ...
	 * The game is lost if the player is dead or an invader crosses
	 * the vertical level of the player.
	...
	/**
	 * Switch the state of the paused field and take appropriate
	 * action for the change in the paused status.
	 */
